...
object GoogleVsApple {
  ...
  lazy val googleTweets: TweetSet = TweetReader.allTweets.filter((tweet:Tweet) => google.exists((term:String) => tweet.text contains term) )
  lazy val appleTweets: TweetSet = TweetReader.allTweets.filter((tweet:Tweet) => apple.exists((term:String) => tweet.text contains term) )
